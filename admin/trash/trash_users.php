<?php $msg='Trash'; $msgl='Trash Users';?>
<?php  include('../../includes/header.php') ?>
<div class="innerright">
	<div class="users_title">
		<div class="link_users">
			<ul class="<?php if($msgl=='Users'){echo'pad';} ?> disp">
				<li><a href="#" id='<?php if($msgl=="Trash Users"){echo"active";}?>'>Trash&nbsp;Users</a></li>
    ...
    if (isset($_GET['d'])) {
     $uid=$_GET['d'];
     $update_users=mysqli_query($db,"UPDATE users SET users.u_status='active' WHERE users.u_id='$uid'");
     ...
     if ($update_users) {
     	...
     	$insert_metric=mysqli_query($db,"INSERT INTO metric VALUES(NULL,'$user_id','Active $user to users  on ',current_timestamp())");
     	echo "<script>alert('ACTIVE $user TO USERS')</script>";
     	}	
    }
	 ?>
	...
	<div class="innerright_table">
		<table>
			...
			<tbody>
                ...
                $display_users=mysqli_query($db,"SELECT * FROM users WHERE users.u_status='deleted'");

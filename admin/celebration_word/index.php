<?php $msg='Celebration Word'; $msgl='Celebration Word';?>
<?php  include('../../includes/header.php') ?>

<div class="innerright">
	<div class="users_title">
		<div class="link_users">
			<ul class="<?php if($msgl=='Celebration Word'){echo'pad';} ?> disp">
				<li><a href="#" id='<?php if($msgl=="Celebration Word"){echo"active";}?>'>CELEBRATION WORD</a></li>
		...
		<div class="menu">
			...
			<ul class="<?php if($msgl=='Celebration Word'){echo'pad';} ?> disp1 " >
				<li><a href="#" id='<?php if($msgl=="Celebration Word"){echo"active";}?>'>CELEBRATION WORD</a></li>
				<!-- <li><a href="volunteerss.php" id='<?php if($msg=="Volunteerss"){echo"active";}?>'>Volunteer&nbsp;Supervisors</a></li>
				<li><a href="volunteers.php" id='<?php if($msg=="Volunteers"){echo"active";}?>'>Volunteers</a></li> -->
			</ul>
	...
	<div class="insert_user">
		...
		<button class="open"><img src="../../photo/Bible.png"></button>
		 <?php } ?>
	</div>	

<?php $msg='Users'; $msgl='Volunteers Supervisors';?>
	...
	<div class="users_title">
		<div class="link_users">
			<ul class="<?php if($msgl=='Users'){echo'pad';} ?> disp">
				...
				<li><a href="#" id='<?php if($msgl=="Volunteers Supervisors"){echo"active";}?>'>Volunteer&nbsp;Supervisors</a></li>
...
<div class="innerright_table">
		<table>
			...
			<tbody>
                ...
                $display_users=mysqli_query($db,"SELECT * FROM users WHERE users.u_status='active' AND users.u_role='Volunteer Supervisor'");
